 ...
 * 最简单的 单向队列  使用数组实现
 */
public class ArrayQueueSingleTrack {
    //底层使用数组实现
    private long[] arr;
    //有效数据大小
     ...
     * 带参数的构造方法
     */
    public ArrayQueueSingleTrack(int maxSize){
    ...
    public static void main(String[] args){
        ArrayQueueSingleTrack aq = new ArrayQueueSingleTrack(5);
        aq.insert(13);
        aq.insert(1);
        aq.insert(34);
        aq.insert(22);
